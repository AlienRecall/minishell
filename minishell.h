...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/20 20:09:05 by lfrancav &        #+#    #+#             */
/*   Updated: 2024/02/28 18:52:59 by lfrancav &       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define SHELL_NAME "\e[0;36m🐐 Minishell$\033[0m "
...
# define ERROR_UNCLOSED_PAR -3
# define ERROR_MORE_CLOS_PAR -4
# define ERROR_CANT_OPENDIR -5
# define ERROR_NO_MATCHES_FOUND -6
...
char					*solve_value_body(t_all *all, char *value,
							int *has_wildcard, int hd);
